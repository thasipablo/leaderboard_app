...
**Leaderboard** is a simple score list app built for API learning purpose.
...
```sh
  git clone git@github.com:thasipablo/leaderboard_app.git
  cd leaderboard_app
  npm install
  npm run dev
```
...
Feel free to check the [issues page](https://github.com/thasipablo/leaderboard_app/issues).
